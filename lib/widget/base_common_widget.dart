...
abstract class BaseCommonWidget extends StatefulWidget {
  ...
  const BaseCommonWidget({
    ...
    this.behavior,
        ...
        this.isBlur = isBlur ?? false,
        this.blurColor = blurColor ?? Colors.transparent,
        this.blurSigmaX = blurSigmaX ?? 5,
        this.blurSigmaY = blurSigmaY ?? 5,
        this.inkShowPos = inkShowPos ?? InkShowPos.topLevel,
        this.alignment = alignment ?? Alignment.center,
        this.enabled = enabled ?? true,
        this.popupOnEvent = popupOnEvent ?? PopupOnEvent.onTap,
        super(key: key);
