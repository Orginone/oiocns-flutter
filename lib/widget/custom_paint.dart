...
class CustomAssetsListItemButton extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    RRect rRect =
        RRect.fromLTRBR(0, 0, size.width, size.height, const Radius.circular(4));
...
class CustomTopBulgeShape extends ShapeBorder {
  ...
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) {
    ...
    RRect rRect = RRect.fromRectAndCorners(rect,bottomLeft: Radius.circular(8.w),bottomRight: Radius.circular(8.w));
    path.addRRect(rRect);
