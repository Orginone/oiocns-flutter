...
import 'package:orginone/pages/setting/organization/friends/new_friend/new_friends_controller.dart';
        ...
        children: [
          Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: UnifiedColors.cardBorder, width: 0.1.w),
          ...
          Align(
            ...
            child: Container(
              ...
              child: Text(controller.getStatus(item.status),
                  softWrap: false, style: AFont.instance.size18White),
            ),
          ),
        ],
      ),
