                  ...
                  children: [
                    ...
                    Obx(() {
                      if(state.showSearch.value){
                        return Column(
                          children: state.searchMember.map((element) => item(element))
                              .toList(),
                        );
                      }
                      return Column(
                        children: state.unitMember.map((element) => item(element))
                            .toList(),
                      );
                    })
                  ],
          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text("账号:${item.code}", style: TextStyle(color: Colors.black,
                      fontSize: 18.sp,
