          ...
          children: [
            ...
            Obx(() {
              ...
              for (var element in state.dictItems) {
                content.add([element.name,element.value,DateTime.tryParse(element.createTime)?.format(format: "yyyy-MM-dd HH:mm:ss")??""]);
              }
              return CommonWidget.commonDocumentWidget(
                  ...
                  showOperation: true,
                  popupMenus: [
                    const PopupMenuItem(value: "edit",child: Text("编辑字典项"),),
                    const PopupMenuItem(value: "delete",child: Text("删除字典项"),),
