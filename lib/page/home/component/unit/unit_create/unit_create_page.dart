  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<UnitCreateController>(
        ...
        builder: (item) => UnifiedScaffold(
            appBarTitle: Text("创建单位", style: text16),
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration:
                                  const InputDecoration(hintText: '请输入单位名称'),
                        ...
                        Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration:
                                  const InputDecoration(hintText: '请输入团队简称'),
                              keyboardType: TextInputType.text,
                              validator: (value) {
                                if (TextUtil.isEmpty(value)) {
                                  return "团队简称不能为空!";
                        ...
                        Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration:
                              const InputDecoration(hintText: '请输入团队标识'),
                              keyboardType: TextInputType.text,
                              validator: (value) {
                                if (TextUtil.isEmpty(value)) {
                                  return "团队标识不能为空!";
