...
class TextHighlight extends StatelessWidget {
  ...
  final int maxLines;
  TextHighlight({this.content, this.keyWord, this.normalStyle, this.highlightStyle,this.maxLines = 1});

  @override
  Widget build(BuildContext context) {
    if(this.keyWord == null || this.keyWord == "") return Text(content!, style: normalStyle,);
    List<TextSpan> spans = [];
    int start = 0;
    int end;
    ...
    return RichText(text: TextSpan(children: spans),maxLines: maxLines,);
  }
}