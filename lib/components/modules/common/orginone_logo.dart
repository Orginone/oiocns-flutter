...
class OrginoneLogo extends StatelessWidget {
  const OrginoneLogo({
    super.key,
    this.size,
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      duration: duration,
      curve: curve,
      decoration: OrginoneLogoDecoration(
        style: style,
        textColor: textColor,
      ),
    );
...
class OrginoneLogoDecoration extends Decoration {
  ...
  const OrginoneLogoDecoration._(
  ...
  static OrginoneLogoDecoration? lerp(
      OrginoneLogoDecoration? a, OrginoneLogoDecoration? b, double t) {
    ...
    if (a == null) {
      return OrginoneLogoDecoration._(
        b!.textColor,
        b.style,
        b.margin * t,
        b._position,
  ...
  @override
  OrginoneLogoDecoration? lerpFrom(Decoration? a, double t) {
    assert(debugAssertIsValid());
    if (a == null || a is OrginoneLogoDecoration) {
      assert(a == null || a.debugAssertIsValid());
      return OrginoneLogoDecoration.lerp(a as OrginoneLogoDecoration?, this, t);
    }
    return super.lerpFrom(a, t) as OrginoneLogoDecoration?;
  }

  @override
  OrginoneLogoDecoration? lerpTo(Decoration? b, double t) {
    assert(debugAssertIsValid());
    if (b == null || b is OrginoneLogoDecoration) {
      assert(b == null || b.debugAssertIsValid());
      return OrginoneLogoDecoration.lerp(this, b as OrginoneLogoDecoration?, t);
    }
    return super.lerpTo(b, t) as OrginoneLogoDecoration?;
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is OrginoneLogoDecoration &&
...
class _FlutterLogoPainter extends BoxPainter {
  ...
  final OrginoneLogoDecoration _config;
  ...
  void _paintLogo(Canvas canvas, Rect rect) {
    ...
    final Path topBeam = Path()
          ..moveTo(3.913, 4.024)
          ..cubicTo(0.95, 0.44, 2.189, 0.911, 3.678, 1.233)
          ..cubicTo(1.76, 0.378, 3.3, 0.424, 4.464, 0.373761311)
          ..cubicTo(1.76, 0.378, 3.3, 0.424, 4.464, 0.373761311)
        // ..arcTo(Rect, startAngle, sweepAngle, forceMoveTo)
        ;
    canvas.drawPath(topBeam, lightPaint);
    // <path fill="color(display-p3 .1529 .1451 .5412)" d="
    //M3.913 4.024
    //c.95-.44 2.189-.911 3.678-1.233 1.76-.378 3.3-.424 4.464-.373.761.311 2.706 1.233 3.893 3.357.166.296.655 1.223.857 2.536.321 2.094-.321 3.694-.482 4.073
    //a7.317 7.317 0 0 1-1.16 1.875
    //c.202-.355.539-1.06.572-2 .008-.238.037-1.678-1-2.911-.89-1.06-2.04-1.334-2.802-1.518-3.041-.73-5.564.852-5.82 1.018-1.9 1.225-2.687 2.96-2.951 3.642
    //a7.746 7.746 0 0 0-.518 3.018
    //A22.78 22.78 0 0 1 3.913 4.024Z"/>
