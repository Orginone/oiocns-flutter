...
TaskEntity $TaskEntityFromJson(Map<String, dynamic> json) {
	...
	final TaskFlowNode? flowNode = jsonConvert.convert<TaskFlowNode>(json['flowNode']);
	if (flowNode != null) {
		taskEntity.flowNode = flowNode;
	}
	final TaskFlowInstance? flowInstance = jsonConvert.convert<TaskFlowInstance>(json['flowInstance']);
...
TaskFlowInstance $TaskFlowInstanceFromJson(Map<String, dynamic> json) {
	...
	final TaskFlowInstanceFlowRelation? flowRelation = jsonConvert.convert<TaskFlowInstanceFlowRelation>(json['flowRelation']);
...
TaskFlowInstanceFlowRelation $TaskFlowInstanceFlowRelationFromJson(Map<String, dynamic> json) {
	final TaskFlowInstanceFlowRelation taskFlowInstanceFlowRelation = TaskFlowInstanceFlowRelation();
	final String? id = jsonConvert.convert<String>(json['id']);
	if (id != null) {
...
Map<String, dynamic> $TaskFlowInstanceFlowRelationToJson(TaskFlowInstanceFlowRelation entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['id'] = entity.id;
