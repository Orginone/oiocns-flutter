...
InstanceTaskEntity $InstanceTaskEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<InstanceTaskFlowTasks>? flowTasks =
      jsonConvert.convertListNotNull<InstanceTaskFlowTasks>(json['flowTasks']);
  if (flowTasks != null) {
    instanceTaskEntity.flowTasks = flowTasks;
  }
  final InstanceTaskFlowDefine? flowDefine =
      jsonConvert.convert<InstanceTaskFlowDefine>(json['flowDefine']);
  if (flowDefine != null) {
    instanceTaskEntity.flowDefine = flowDefine;
  }
  final InstanceTaskFlowRelation? flowRelation =
      jsonConvert.convert<InstanceTaskFlowRelation>(json['flowRelation']);
...
InstanceTaskFlowTasks $InstanceTaskFlowTasksFromJson(
...
Map<String, dynamic> $InstanceTaskFlowTasksToJson(
    InstanceTaskFlowTasks entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
...
InstanceTaskFlowDefine $InstanceTaskFlowDefineFromJson(
    Map<String, dynamic> json) {
  final InstanceTaskFlowDefine instanceTaskFlowDefine =
...
Map<String, dynamic> $InstanceTaskFlowDefineToJson(
    InstanceTaskFlowDefine entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
...
InstanceTaskFlowRelation $InstanceTaskFlowRelationFromJson(
    Map<String, dynamic> json) {
  final InstanceTaskFlowRelation instanceTaskFlowRelation =
...
Map<String, dynamic> $InstanceTaskFlowRelationToJson(
    InstanceTaskFlowRelation entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
