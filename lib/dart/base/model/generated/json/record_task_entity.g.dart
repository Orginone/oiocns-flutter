...
RecordTaskEntity $RecordTaskEntityFromJson(Map<String, dynamic> json) {
  ...
  final RecordTaskFlowTask? flowTask =
      jsonConvert.convert<RecordTaskFlowTask>(json['flowTask']);
  if (flowTask != null) {
...
RecordTaskFlowTask $RecordTaskFlowTaskFromJson(Map<String, dynamic> json) {
  ...
  final RecordTaskFlowTaskFlowNode? flowNode =
      jsonConvert.convert<RecordTaskFlowTaskFlowNode>(json['flowNode']);
  if (flowNode != null) {
    recordTaskFlowTask.flowNode = flowNode;
  }
  final RecordTaskFlowTaskFlowInstance? flowInstance =
      jsonConvert.convert<RecordTaskFlowTaskFlowInstance>(json['flowInstance']);
...
RecordTaskFlowTaskFlowNode $RecordTaskFlowTaskFlowNodeFromJson(
    Map<String, dynamic> json) {
  final RecordTaskFlowTaskFlowNode recordTaskFlowTaskFlowNode =
...
Map<String, dynamic> $RecordTaskFlowTaskFlowNodeToJson(
    RecordTaskFlowTaskFlowNode entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
...
RecordTaskFlowTaskFlowInstance $RecordTaskFlowTaskFlowInstanceFromJson(
    Map<String, dynamic> json) {
  final RecordTaskFlowTaskFlowInstance recordTaskFlowTaskFlowInstance =
  ...
  final RecordTaskFlowTaskFlowInstanceFlowRelation? flowRelation =
      jsonConvert.convert<RecordTaskFlowTaskFlowInstanceFlowRelation>(
          json['flowRelation']);
...
Map<String, dynamic> $RecordTaskFlowTaskFlowInstanceToJson(
    RecordTaskFlowTaskFlowInstance entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
...
RecordTaskFlowTaskFlowInstanceFlowRelation
    $RecordTaskFlowTaskFlowInstanceFlowRelationFromJson(
        Map<String, dynamic> json) {
  final RecordTaskFlowTaskFlowInstanceFlowRelation
      recordTaskFlowTaskFlowInstanceFlowRelation =
      RecordTaskFlowTaskFlowInstanceFlowRelation();
  final String? id = jsonConvert.convert<String>(json['id']);
  if (id != null) {
...
Map<String, dynamic> $RecordTaskFlowTaskFlowInstanceFlowRelationToJson(
    RecordTaskFlowTaskFlowInstanceFlowRelation entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
