...
VersionEntity $VersionEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<VersionVersionMes>? versionMes =
      jsonConvert.convertListNotNull<VersionVersionMes>(json['versionMes']);
  if (versionMes != null) {
...
VersionVersionMes $VersionVersionMesFromJson(Map<String, dynamic> json) {
  ...
  final VersionVersionMesUploadName? uploadName =
      jsonConvert.convert<VersionVersionMesUploadName>(json['uploadName']);
  if (uploadName != null) {
  ...
  final VersionVersionMesPubTeam? pubTeam =
      jsonConvert.convert<VersionVersionMesPubTeam>(json['pubTeam']);
  if (pubTeam != null) {
    versionVersionMes.pubTeam = pubTeam;
  }
  final VersionVersionMesPubAuthor? pubAuthor =
      jsonConvert.convert<VersionVersionMesPubAuthor>(json['pubAuthor']);
  if (pubAuthor != null) {
...
VersionVersionMesUploadName $VersionVersionMesUploadNameFromJson(
    Map<String, dynamic> json) {
  final VersionVersionMesUploadName versionVersionMesUploadName =
...
Map<String, dynamic> $VersionVersionMesUploadNameToJson(
    VersionVersionMesUploadName entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['size'] = entity.size;
  data['name'] = entity.name;
  data['extension'] = entity.extension;
...
VersionVersionMesPubTeam $VersionVersionMesPubTeamFromJson(
    Map<String, dynamic> json) {
  final VersionVersionMesPubTeam versionVersionMesPubTeam =
  ...
  final VersionVersionMesPubTeamTeam? team =
      jsonConvert.convert<VersionVersionMesPubTeamTeam>(json['team']);
  if (team != null) {
...
Map<String, dynamic> $VersionVersionMesPubTeamToJson(
    VersionVersionMesPubTeam entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
VersionVersionMesPubTeamTeam $VersionVersionMesPubTeamTeamFromJson(
    Map<String, dynamic> json) {
  final VersionVersionMesPubTeamTeam versionVersionMesPubTeamTeam =
...
Map<String, dynamic> $VersionVersionMesPubTeamTeamToJson(
    VersionVersionMesPubTeamTeam entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
  data['name'] = entity.name;
  data['code'] = entity.code;
...
VersionVersionMesPubAuthor $VersionVersionMesPubAuthorFromJson(
    Map<String, dynamic> json) {
  final VersionVersionMesPubAuthor versionVersionMesPubAuthor =
  ...
  final VersionVersionMesPubAuthorTeam? team =
      jsonConvert.convert<VersionVersionMesPubAuthorTeam>(json['team']);
  if (team != null) {
...
Map<String, dynamic> $VersionVersionMesPubAuthorToJson(
    VersionVersionMesPubAuthor entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
  data['name'] = entity.name;
  data['code'] = entity.code;
...
VersionVersionMesPubAuthorTeam $VersionVersionMesPubAuthorTeamFromJson(
    Map<String, dynamic> json) {
  final VersionVersionMesPubAuthorTeam versionVersionMesPubAuthorTeam =
...
Map<String, dynamic> $VersionVersionMesPubAuthorTeamToJson(
    VersionVersionMesPubAuthorTeam entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
  data['name'] = entity.name;
  data['code'] = entity.code;
