...
import 'package:orginone/dart/base/model/generated/json/instance_task_entity.g.dart';
...
class InstanceTaskEntity {
  ...
  factory InstanceTaskEntity.fromJson(Map<String, dynamic> json) =>
      $InstanceTaskEntityFromJson(json);
...
class InstanceTaskFlowTasks {
  ...
  factory InstanceTaskFlowTasks.fromJson(Map<String, dynamic> json) =>
      $InstanceTaskFlowTasksFromJson(json);
...
class InstanceTaskFlowDefine {
  ...
  factory InstanceTaskFlowDefine.fromJson(Map<String, dynamic> json) =>
      $InstanceTaskFlowDefineFromJson(json);
...
class InstanceTaskFlowRelation {
  ...
  factory InstanceTaskFlowRelation.fromJson(Map<String, dynamic> json) =>
      $InstanceTaskFlowRelationFromJson(json);
