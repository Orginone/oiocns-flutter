...
StagingEntity $StagingEntityFromJson(Map<String, dynamic> json) {
	...
	final String? merchandiseId = jsonConvert.convert<String>(json['merchandiseId']);
	...
	final MarketEntity? market = jsonConvert.convert<MarketEntity>(json['market']);
	if (market != null) {
		stagingEntity.market = market;
	}
	final MerchandiseEntity? merchandise = jsonConvert.convert<MerchandiseEntity>(json['merchandise']);
	if (merchandise != null) {
