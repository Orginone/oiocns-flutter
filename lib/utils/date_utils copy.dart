...
class DateTimeUtils {
  ...
  static String formatDateMilliseconds(int ms,
      {bool isUtc = false, String format = "yyyy/M/d HH:mm:ss"}) {
  ...
  static DateTime addMonths(DateTime date, int months) {
    var res = DateTimeUtils.copyWith(date, month: date.month + months);
    if (date.day != res.day) res = DateTimeUtils.copyWith(res, day: 0);
    return res;
  }
