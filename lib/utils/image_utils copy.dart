...
class ImageUtils {
  ...
  //   Response response = await HttpService.to.get(url);
  ...
  static CachedNetworkImage showNetImageWh(
  ...
  static CachedNetworkImage showNetImageWhClip(
      String? url, double width, double height, double circular) {
    return CachedNetworkImage(
      width: width,
      height: height,
      imageUrl: url ?? '',
